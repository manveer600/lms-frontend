  ...
  return (
    <HomeLayout>
      <div className="min-h-[90vh]  pt-12 px-20 flex flex-col items-center justify-center text-white">
        {/* <div className="sm:grid sm:w-[1000px] border flex flex-col sm:grid-cols-2 gap-10 py-10 relative">
          <div className="space-y-5 ">
            ...
            <button onClick={()=>navigate(-1)} className=" border-2 border-red-200 text-serif rounded-md font-bold px-5 py-3 hover:text-black hover:bg-yellow-500 transition-all ease-in-out duration-300">Go back</button>
            </div>
          </div>
        ...
        <div className="flex w-[100vw] flex-col sm:space-x-2 sm:flex-row">
          ...
          <div className="pt-4 m-6 sm:ml-6 pr-4 sm:w-1/2 flex flex-col justify-center items-center space-y-2 sm:items-end">
            <div>
              <img
                className="w-[300px] sm:h-[256px] sm:w-[390px] mb-4 sm:w-42 md:h-64"
                alt="thumbnail"
                src={state?.thumbnail?.secure_url}
              />
            </div>

            {/* <div className="m-auto border space-y-1 w-full items-end flex flex-col "> */}
              <div className="font-serif w-[300px] sm:w-full md:w-[390px] flex flex-col items-center justify-between text-xl">
                <p className="font-semibold">
                  <span className="text-yellow-500 font-bold">
                    Total lectures :{" "}
                  </span>
                ...
                {role === "ADMIN" || data?.subscription?.status === "active" ? (
                  <button
                    ...
                    className="bg-yellow-600 w-[300px] text-xl rounded-md font-bold px-5 py-3 hover:bg-yellow-500 transition-all ease-in-out duration-300"
                  >
                    Watch lectures
                  </button>
                ) : (
                  <button
                    ...
                    className="bg-yellow-600 w-[300px] text-xl rounded-md font-bold px-5 font-serif py-3 hover:bg-yellow-500 transition-all ease-in-out duration-300"
                  >
                    Subscribe
                  </button>
                )}
